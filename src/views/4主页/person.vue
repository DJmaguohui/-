<template>
  <div class="personOutBox">
    <div class="person">
      ...
      <div class="centerLink" @click="share">
    ...
    <van-popup v-model="show">
      <div class="share">
        ...
        <div class="finger">
          <img src="../../assets/icon_home_finger.png" alt />
          <p>长按保存到相册</p>
        </div>
      </div>
    </van-popup>
